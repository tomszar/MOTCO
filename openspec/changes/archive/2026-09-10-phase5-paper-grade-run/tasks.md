...
- [x] 5.3 Commit `results/phase5-<UTC date>/report/` and `PROVENANCE.txt`; verify `git status` shows no JSONL staged and that the committed `report/` regenerates byte-identically from the merged JSONL.
