...
> Confirmed: the orientation sign-anchor defect fixed in `fix-orientation-sign-anchor` was ruled out as
> the cause on 2026-08-28 — corrected power is 0.68 against the 0.80 floor and the null-cell artifact
> is unchanged. This contract applies.
