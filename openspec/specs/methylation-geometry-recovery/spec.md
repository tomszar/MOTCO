# methylation-geometry-recovery Specification

## Purpose
Characterize whether representing methylation in beta-value space (versus M-value/logit space) introduces geometric distortion or cross-talk between magnitude and orientation statistics, isolating the sigmoid nonlinearity as a factor independent of the InterSIM generator and cross-omic cascade.
