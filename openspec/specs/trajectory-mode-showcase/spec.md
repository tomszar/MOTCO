# trajectory-mode-showcase Specification

## Purpose

Provide an end-to-end showcase that injects each trajectory mode into a single shared InterSIM baseline and renders a multi-panel PLS-DA trajectory figure, exposed through a thin CLI script.
