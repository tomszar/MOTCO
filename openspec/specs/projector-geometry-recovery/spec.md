# projector-geometry-recovery Specification

## Purpose
Characterize whether the choice of integration projector (standardisation, concat, SNF, PLS) introduces geometric distortion or cross-talk between magnitude, orientation, and shape statistics, isolating the projector as a factor independent of methylation nonlinearity and the InterSIM generator.
