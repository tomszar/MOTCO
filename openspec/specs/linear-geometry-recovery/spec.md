# linear-geometry-recovery Specification

## Purpose
Define the minimal Gaussian two-stage test bed used to establish a clean-floor existence proof for magnitude (delta) and orientation (angle) recovery under a linear PCA projector, prior to introducing the InterSIM generator or other structural factors.
