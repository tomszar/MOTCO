# latent-space-crosstalk-study Specification

## Purpose
Make the dominant-specificity study latent-space-selectable so cross-talk between magnitude, orientation, and shape statistics can be characterized and compared across concat, SNF, and PLS latent spaces.
